# PSOC&trade; Control C1 MCU: CCU8 capture

This code example demonstrates the capture feature of Capture and Compare Unit 8 (CCU8) slices available in PSOC&trade; Control C1 MCU.

The code example uses two CCU8 slices of the PSOC&trade; Control C1 MCU:
...
[View this README on GitHub.](https://github.com/Infineon/mtb-example-ce242905-ccu8-capture)

[Provide feedback on this code example.](https://yourvoice.infineon.com/jfe/form/SV_1NTns53sK2yiljn?Q_EED=)
...
The following example clones the "[CCU8 capture](https://github.com/Infineon/mtb-example-ce242905-ccu8-capture)" application with the desired name "CCU8 capture" configured for the *KIT_PSC1M3_EVK* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSC1M3_EVK --app-id mtb-example-ce242905-ccu8-capture --user-app-name CCU8 capture --target-dir "C:/mtb_projects"
   ```
...
3. Program the board using one of the following:
   ...
   <details><summary><b>Using Eclipse IDE</b></summary>
      ...
      b. In the **Quick Panel**, scroll down, and click **\<Application Name> Program (JLink)**
   </details>
...
4. An LED connected to the P4.6 GPIO pin blinks
...
| CCU8 1 (CC8 0) (PDL)	        |CAPTURE_SLICE	    | CCU8 slice configured for timer capture |
| CCU8 1 (CC8 1)(PDL)	    	|PWM_SLICE	    | CCU8 slice configured for PWM output generation|
...
Document title: *CE242905* – *PSOC&trade; Control C1 MCU: CCU8 capture*
